...
## 1. Import and Analyze Diamonds Dataset

The diamonds dataset is available in the seaborn visualization package. Let's load the dataset and analyze its features and instances. 
